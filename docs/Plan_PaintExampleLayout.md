...
## Outstanding Issues
1. ⏳ **Inspector surfacing** – Now that screenshot metadata lives under `diagnostics/ui/paint_example/screenshot_baseline`, wire the inspector dashboards so regressions show up before we look at PNG diffs.
