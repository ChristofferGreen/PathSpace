...
12. ✅ (November 7, 2025) Hooked the CLI roundtrip harness into automation: telemetry files (`history_cli_roundtrip/telemetry.json`) and PSHD pairs now land in the artifact directories for every CTest/pre-push run, giving dashboards and inspector tooling a stable feed of bundle hashes + entry counts.
