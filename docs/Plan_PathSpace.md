...
13. Integrate the aggregated history telemetry into inspector UI charts and CI dashboards (consume `history_cli_roundtrip/index.json`, expose bundle download links, and alert when hashes diverge).
