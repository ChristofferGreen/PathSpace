...
- 📌 (November 7, 2025) Update `docs/finished/Plan_WidgetDeclarativeAPI_Finished.md` and related plans to consume the new routing/history APIs once they land, keeping the declarative widget roadmap aligned.
