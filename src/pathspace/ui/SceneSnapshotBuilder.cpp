...
auto compute_drawable_fingerprints(DrawableBucketSnapshot const& bucket) -> Expected<std::vector<std::uint64_t>> {
    ...
    auto clamp_payload_span = [&](std::size_t offset, std::size_t size) -> std::pair<void const*, std::size_t> {
