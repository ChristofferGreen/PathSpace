...
constexpr SchemaEntry kPaintSurfaceEntries[] = {
    ...
    {"state/history/<stroke-id>/meta", NodeKind::Value, Requirement::RuntimeManaged, "Stroke metadata (brush + color + commit flag)."},
    {"state/history/<stroke-id>/points", NodeKind::Value, Requirement::RuntimeManaged, "Stroke point list in widget-local coordinates."},
    {"state/history/last_stroke_id", NodeKind::Value, Requirement::RuntimeManaged, "Most recent stroke identifier processed by the runtime."},
    ...
    {"render/buffer/revision", NodeKind::Value, Requirement::RuntimeManaged, "Monotonic revision counter incremented after each stroke mutation."},
