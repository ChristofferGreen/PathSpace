...
/*
Need to split the input path so we read from the fs with the split path starting with the right of the path starting from the ps::fs path
*/
auto PathFileSystem::outMinimal(Iterator const& path, InputMetadata const& inputMetadata, void* obj, bool const doExtract) -> std::optional<Error> {
