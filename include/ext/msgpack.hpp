...
// From https://github.com/simonspa/cppack/tree/master
...
namespace msgpack
{
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, int8_t>::unpack_type(Unpacker<InputIt> &u, int8_t &value)
    {
        if (u.safe_data() == int8)
        {
            u.safe_increment();
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, int16_t>::unpack_type(Unpacker<InputIt> &u, int16_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, int32_t>::unpack_type(Unpacker<InputIt> &u, int32_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, int64_t>::unpack_type(Unpacker<InputIt> &u, int64_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, uint8_t>::unpack_type(Unpacker<InputIt> &u, uint8_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, uint16_t>::unpack_type(Unpacker<InputIt> &u, uint16_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, uint32_t>::unpack_type(Unpacker<InputIt> &u, uint32_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, uint64_t>::unpack_type(Unpacker<InputIt> &u, uint64_t &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, std::nullptr_t>::unpack_type(Unpacker<InputIt> &u, std::nullptr_t & /*value*/)
    {
        u.safe_increment();
    }
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, bool>::unpack_type(Unpacker<InputIt> &u, bool &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, float>::unpack_type(Unpacker<InputIt> &u, float &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, double>::unpack_type(Unpacker<InputIt> &u, double &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, std::string>::unpack_type(Unpacker<InputIt> &u, std::string &value)
    {
    ...
    template <class InputIt>
    inline void UnpackerImpl<InputIt, std::vector<uint8_t>>::unpack_type(Unpacker<InputIt> &u, std::vector<uint8_t> &value)
    {
